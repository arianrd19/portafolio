...
const projects: Project[] = [
  { num: "01", title: "Vamos Rural", desc: "Rural tourism platform in the Dominican Republic", stack: ["React", "Next.js", "TypeScript", "Django", "PostgreSQL", "Docker"], date: "Sep. 2025", url: "https://www.vamosrural.com/" },
  { num: "02", title: "Mapple Studios SRL", desc: "Online sublimation and custom merchandise store in the Dominican Republic", stack: ["JavaScript", "PHP", "MySQL"], date: "Ene. 2026", url: "https://www.mapplestudios.com/" },
  { num: "03", title: "Active Labor Solutions", desc: "Job platform in the Dominican Republic — connects candidates and companies", stack: ["JavaScript", "PHP", "MySQL"], date: "Ene. 2025", url: "https://www.als.com.do/" },
  { num: "04", title: "Easy Online English", desc: "Course platform to learn how to speak English online", stack: ["React", "TypeScript", "Node.js", "MongoDB"], date: "Ene. 2024", url: "https://www.easyonlineenglish.com/" },
  { num: "05", title: "Las Lomas Serenas", desc: "Real estate website with affordable apartment project", stack: ["JavaScript", "PHP", "MySQL"], date: "Ene. 2026", url: "https://www.laslomasserenas.com/" },
  { num: "06", title: "Estancia Las Mercedes", desc: "Apartment rental website built on WordPress", stack: ["WordPress", "PHP", "MySQL"], date: "Ene. 2023", url: "https://www.estancia-lasmercedes.com/" },
];
            ...
            <Reveal key={p.num} delay={i * 90}>
              ...
              >
                ...
                <div className="relative flex items-start justify-between font-mono-ui text-xs text-muted-foreground">
                  ...
                  <span className="arrow text-lime">View project ↗</span>
                </div>
                <h3 className="relative mt-8 text-2xl font-semibold tracking-tight transition-colors group-hover:text-lime">
                  {p.title}
                </h3>
                <p className="relative mt-2 text-sm text-muted-foreground max-w-md">{p.desc}</p>
