    ...
    <section id="about" className="px-6 md:px-10 py-24 border-t border-border/60">
      <div className="mx-auto max-w-7xl grid lg:grid-cols-[1fr_1.4fr] gap-14 items-start">
        <div className="relative">
          <div className="aspect-square w-full max-w-md rounded-2xl bg-gradient-to-br from-secondary to-card border border-border overflow-hidden flex items-end justify-center">
            <div className="size-full flex items-center justify-center font-mono-ui text-muted-foreground text-xs">
              <div className="text-center">
                <div className="size-32 mx-auto mb-4 rounded-full bg-lime/20 border border-lime flex items-center justify-center">
        ...
        <div>
          ...
          <a
            href="#contact"
            className="inline-block bg-lime text-primary-foreground px-6 py-3 rounded-md font-mono-ui text-sm font-semibold hover:opacity-90 transition-opacity"
          >
            Let's work together →
          </a>
        </div>
