...
export function Values() {
  ...
  return (
    <section className="px-6 md:px-10 py-10 md:py-16 border-t border-border/60">
          ...
          {values.map((v, i) => (
            <Reveal key={v.num} index={i} delayStep={120}>
              <div className="hover-lift bg-card border border-border rounded-xl p-8 group h-full">
                ...
                <h3 className="mt-6 text-2xl font-semibold transition-colors group-hover:text-lime">
                  {v.title}
                </h3>
